...
<%
    ...
    JsonNode k = (JsonNode)hs.getAttribute("result");
    String s = (String)hs.getAttribute("search");
%>
...
<html>
    ...
    <body>
        ...
        <a href="Login?p=search"><h3>ログイン</h3></a>
                <%}else{%>
        <a href="Login"><h3>ログアウト</a> <a href="Mydata">マイページ</a>　<a href="Cart">カート</h3></a>
        <%}%><br>
        <%=s%>の検索結果<br>
